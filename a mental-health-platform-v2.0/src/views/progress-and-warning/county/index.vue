    ...
    <div class="progress-block">
      <div class="progress-box">
        <div class="progress">
          ...
          <circle-progress :radius="'36%'" :id="'countyCP'" :percent="warnStatistics.completePercent"
        ...
        <div class="info">
          <div class="info-block">
            ...
            <p class="info-data">
              <span class="data">{{warnStatistics.completeSchool}}</span>
      ...
      <div class="progress-box">
        <div class="progress">
          ...
          <circle-progress :radius="'36%'" :id="'countyVD'" :percent="warnStatistics.validPercent"
            class="circle-progress"></circle-progress>
        </div>
        <div class="info">
          <div class="info-block">
      ...
      <div class="progress-box">
        <div class="progress">
          ...
          <circle-progress :radius="'36%'" :id="'countyWP'" :percent="warnStatistics.warnPercent"
            class="circle-progress"></circle-progress>
        </div>
        <div class="info">
          <div class="info-block">
