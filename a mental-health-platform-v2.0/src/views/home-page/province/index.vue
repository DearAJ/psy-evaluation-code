      ...
      <div class="right">
          ...
          <div class="service-data-block">
            ...
            <div class="data-panel bg-box">
              ...
              <div class="data-panel-box box-content">
                <div class="data-box">
                  <div class="img-bg">
                    <p class="number">{{ dataPanel.cityNum }}/{{ dataPanel.countyNum }}</p>
                    <p class="extra">市级/区县数量</p>
                  </div>
                </div>
                <div class="data-box">
                  <div class="img-bg">
        ...
        <div class="task-progress-block bg-box">
          <p class="box-title">
            ...
            <span class="location province">{{province}}</span>
            <span v-if="selectedCity" class="location city">-{{selectedCity}}</span>
          </p>
...
export default {
  ...
  computed: {
    ...
    mapName() {
      return this.$mapMapping[this.province]
    }
  },
  mounted(){
  ...
  data() {
    return {
      ...
      selectedCity: '', // 选中的市，注意，任务进度那一开始没选中，显示省的，选中了显示市的，切换的时候可以在mapClick函数中重新获取数据
      periodWarningData: {
  ...
  methods: {
      ...
      taskStatistics(data).then(res => {
        if (res.result) {
          ...
          if (data.city != null) {
            ...
            this.taskStatistics.complete = res.result.completeCity;
            this.taskStatistics.unComplete = res.result.unCompleteCity;
          }
    ...
    mapClick(selectedName) {
      if(this.selectedCity === selectedName) {
        // 这样的话是取消选中;
        this.selectedCity = ''
      }else {
        this.selectedCity = selectedName;
      }
      let data = {};
