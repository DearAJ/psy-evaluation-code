    ...
    <div class="progress-block">
      <div class="progress-box">
        <div class="progress">
          ...
          <circle-progress :radius="'36%'" :id="'proCP'" :percent="warnStatistics.completePercent"
            class="circle-progress"></circle-progress>
        </div>
        <div class="info">
          <div class="info-block">
            <p class="info-title">已完成城市</p>
            <p class="info-data">
              <span class="data">{{warnStatistics.completeCity}}</span>
      ...
      <div class="progress-box">
        <div class="progress">
          ...
          <circle-progress :radius="'36%'" :id="'proVD'" :percent="warnStatistics.validPercent"
            class="circle-progress"></circle-progress>
        </div>
        <div class="info">
          <div class="info-block">
      ...
      <div class="progress-box">
        <div class="progress">
          ...
          <circle-progress :radius="'36%'" :id="'proWP'" :percent="warnStatistics.warnPercent"
            class="circle-progress"></circle-progress>
        </div>
        <div class="info">
          <div class="info-block">
      ...
      <div class="search-container">
        <div class="search-box">
          ...
          <el-input class="input" placeholder="请输入" clearable
            v-model="searchForm.city" size="medium">
          </el-input>
        </div>
        <div class="search-box">
          <span>区县：&nbsp;</span>
...
export default {
  name: 'ProvinceProgressAndWarning',
  components: {
    CircleProgress
  },
  mounted() {
